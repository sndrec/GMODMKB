...
function ENT:Initialize()
	...
	self.ThrustOffsetR = Vector(0,0,0)
	self.ForceAngle = Vector(0,0,0)
	self.ForceLinear = Vector(0,0,0)
end
...
function ENT:PhysicsSimulate(phys, deltatime)
	...
	local vLinear = moveDir * power * deltatime
	local vAngular = moveDir * deltatime
